  ...
  describe("applyPrinceEffect", () => {
    ...
    it("should handle normal card swap (other player)", async () => {
      ...
      const mockNewCard = {
        ...
        name: "Handmaid",
        strength: 4,
        effect: "Protection until next turn",
      };
      ...
      expect(result.publicMessage).toContain("commands");
    ...
    it("should handle self-targeting", async () => {
      ...
      const mockNewCard = {
        ...
        name: "Prince",
        strength: 5,
        effect: "Target discards and draws",
      };
      ...
      expect(result.publicMessage).toContain(
        "uses the Prince's wisdom on themselves"
      );
